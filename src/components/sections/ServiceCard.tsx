...
const ServiceCard: React.FC<ServiceCardProps> = ({ 
  ...
  return (
    ...
    >
      <div className="relative rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 ease-out transform h-96 group overflow-hidden border-4 border-transparent hover:border-[#D4AF37]">
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6 text-white">
          ...
          <div className="transition-all duration-300 md:transform md:translate-y-2 md:opacity-0 md:group-hover:translate-y-0 md:group-hover:opacity-100">
