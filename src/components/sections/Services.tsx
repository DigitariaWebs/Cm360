...
const Services = forwardRef<ServicesRef>((props, ref) => {
  const { t } = useI18n();
  const services = [
    {
      ...
      description:
        "Diagnostique de trésorerie approfondi, analyse de l'ensemble de vos opérations pour identifier les inefficacités et les possibilités d'amélioration.",
      details: [
    ...
    },
    {
      ...
      description:
        "Solutions personnalisées pour optimiser la prévision de trésorerie et la gestion de la liquidité, en guidant nos clients dans le choix et le déploiement des outils les plus adaptés afin d'assurer une position de liquidité solide.",
      details: [
    ...
    },
    {
      ...
      description:
        "Forts de notre expérience approfondie des banques et de leurs modèles de tarification, nous vous aidons à diminuer vos frais bancaires, à optimiser vos revenus d'intérêts et à simplifier la gestion de votre trésorerie.",
      details: [
    ...
    },
    {
      ...
      description:
        "Soutien administratif pour les petites et moyennes entreprises; ainsi que les OBNL",
      details: [
        "Tenue de livres",
        "Comptabilité",
    ...
    },
    {
      ...
      description:
        "Sessions de formation dédiées à l'introduction à la gestion de trésorerie et au partage de bonnes pratiques, tout en offrant un soutien régulier à nos clients.",
      details: [
    ...
    },
    {
      ...
      description:
        "Offrir des solutions technologiques sur mesure adaptées aux besoins spécifiques de chaque client.",
      details: [
  ...
  // Expose the openServiceModal method to parent components
  useImperativeHandle(ref, () => ({
    openServiceModal: (serviceTitle: string) => {
  ...
  const activeService = activeModal
    ? services.find((s) => s.title === activeModal)
    : null;
  ...
  return (
    <section
      id="services"
      className="py-20 bg-gray-50 relative z-10 pointer-events-auto"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 pointer-events-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-serif font-bold text-darkgreen mb-4 gold-border pb-6">
